...
public class AppVolumenCM extends AppCompatActivity {
    ...
    private EditText txtAlto, txtElementos,txtDescripcion,cmpDensidadG,cmpWga,cmpDensidadC,cmpDensidadA;
    private TextInputLayout input_cmpAlto, input_cmpElementos,input_cmpDensidadG,input_cmpWga,input_cmpDensidadC,input_cmpDensidadA;
    ...
    //Variables
    private Double volumen, elem, densidadG,densidadA,densidadC,wga,ladoh,gravaArena,resistence,maxiaire,
            v_elemVolumen, v_totalCem, v_totalAre, v_totalGrab, v_totalAgu, v_totalAir;
    private String  estructura, forma, descrip, selec, txt_ladoh, nulo, alerta1,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_volumen_cm);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_volumen_cm));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_volumen_cm));
    ...
    public void onClick(View view) {
        ...
        estructura = this.getString(R.string.title_activity_app_volumen_cm);
        ...
        btnGuardarVolumen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar5("", estructura, forma, nulo, nulo, nulo, txt_ladoh, nulo,
    ...
    public boolean validarcmpAlto(){
        if (txtAlto.getText().toString().trim().isEmpty()) {
            input_cmpAlto.setError(getString(R.string.title_activity_app_volumen));
