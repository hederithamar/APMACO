...
public class AppVolumenTab extends AppCompatActivity {
    private PieChart pieChart;
    private ImageView img_tolteca, img_apasco, img_moctezuma;
    ...
    private Button btnCalcular, btnGuardarTolteca,btnGuardarMoctezu,btnGuardarApasco;
    private TextView resultado, resultadoTolteca, resultadoApasco, resultadoMoctezuma, switchStatus,
    ...
    private Double elem, a_totalCem, a_totalAre, a_totalGrab, a_totalAgu, a_elemVolumen,
            ...
            m_elemVolumen, m_totalCem, m_totalAre, m_totalGrab, m_totalAgu, volumen, diametro;
    private String tipo, estructura, forma, descrip, selec, ladoh, nulo, alerta1, cemTolteca,
            cemApasco, cemMoctezuma, aviso;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_app_volumen_tab);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_volumen_tab));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_volumen_tab));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppVolumenTab.this);
