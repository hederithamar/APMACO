...
public class AppTrapecioCM extends AppCompatActivity {
    ...
    private EditText txtMayor, txtLargo, txtAncho, txtAlto, txtElementos,txtDescripcion,cmpDensidadG,cmpWga,cmpDensidadC,cmpDensidadA;
    private TextInputLayout input_cmpMayor, input_cmpLargo,input_cmpAncho, input_cmpAlto, input_cmpElementos,input_cmpDensidadG,input_cmpWga,input_cmpDensidadC,input_cmpDensidadA;
    ...
    //Variables
    private Double volumen, elem, densidadG,densidadA,densidadC,wga,ladoa,ladob, ladoc, ladoh,gravaArena,resistence,maxiaire,
            v_elemVolumen, v_totalCem, v_totalAre, v_totalGrab, v_totalAgu, v_totalAir;
    private String  estructura, forma, descrip, selec, txt_ladoa, txt_ladob, txt_ladoc, txt_ladoh, nulo, alerta1,
            aviso,selecGravaArena,selecMaxAire,txt_Wga,txt_DensidadG,txt_DensidadC,txt_DensidadA,tipocemento;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_app_trapecio_cm);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_trapecio_cm));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_trapecio_cm));
    ...
    public void onClick(View view) {
        ...
        volumen = calculaVolumen(ladoc, ladob, ladoa, ladob);
        ...
        btnGuardarVolumen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar5("", estructura, forma, txt_ladoa, txt_ladob, txt_ladoh, txt_ladoc, nulo,
