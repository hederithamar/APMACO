...
public class AppParalelepipedoCM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_paralelepipedo_cm);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_paralelepipedo_cm));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_paralelepipedo_cm));
    ...
    public void onClick(View view) {
        ...
        volumen = calculaVolumen(ladoa, ladob, ladoh);
        //Toast.makeText(getApplicationContext(), "volumen: "+volumen, Toast.LENGTH_SHORT).show();
