...
public class AppPiramideRectTruncadaCM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_piramide_rect_truncada_cm);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_piramide_rect_truncada_cm));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_piramide_rect_truncada_cm));
