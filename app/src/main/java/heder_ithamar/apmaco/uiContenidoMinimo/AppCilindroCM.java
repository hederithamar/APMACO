...
public class AppCilindroCM extends AppCompatActivity {
    ...
    private EditText txtDiametro, txtAlto, txtElementos,txtDescripcion,cmpDensidadG,cmpWga,cmpDensidadC,cmpDensidadA;
    private TextInputLayout input_cmpDiametro, input_cmpAlto, input_cmpElementos,input_cmpDensidadG,input_cmpWga,input_cmpDensidadC,input_cmpDensidadA;
    ...
    //Variables
    private Double volumen, elem, densidadG,densidadA,densidadC,wga,ladoc,ladoh,gravaArena,resistence,maxiaire,
            v_elemVolumen, v_totalCem, v_totalAre, v_totalGrab, v_totalAgu, v_totalAir;
    private String  estructura, forma, descrip, selec, txt_ladoc, txt_ladoh, nulo, alerta1,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_cilindro_cm);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_cilindro));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_cilindro));
    ...
    private void inicializarComponentesIU() {
        ...
        input_cmpDiametro = (TextInputLayout) findViewById(R.id.input_cmpLado_c);
        input_cmpAlto = (TextInputLayout) findViewById(R.id.input_cmp_altura);
        ...
        txtDiametro = (EditText)findViewById(R.id.cmpLado_c);
        txtAlto = (EditText)findViewById(R.id.cmpLado_h);
    ...
    public void onClick(View view) {
        ...
        txt_ladoc = txtDiametro.getText().toString();
        ...
        volumen = calculaVolumen( ladoc, ladoh);
        ...
        if(mySwitchSist.isChecked()){
            ...
            //Calculo sin desperdicio
                ...
                imprimeVolumen(op.CalculaContenidoMinSinDes(maxiaire, wga, gravaArena, densidadA, densidadG,
                        resistence, densidadC, volumen, elem));
        ...
        btnGuardarVolumen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar5("", estructura, forma, nulo, nulo, txt_ladoh, txt_ladoc, nulo,
    ...
    public boolean validarcmpDiametro(){
        if (txtDiametro.getText().toString().trim().isEmpty()) {
            input_cmpDiametro.setError(getString(R.string.cmp_ancho));
            requestFocus(txtDiametro);
            return false;
        } else {
            input_cmpDiametro.setErrorEnabled(false);
        }
        return true;
    }
