...
public class AppLabCilindro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_lab_cilindro);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_lab_cilindro));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_lab_cilindro));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppLabCilindro.this);
