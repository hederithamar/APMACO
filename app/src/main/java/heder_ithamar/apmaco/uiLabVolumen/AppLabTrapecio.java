...
public class AppLabTrapecio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_lab_trapecio);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_lab_trapecio));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_lab_trapecio));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppLabTrapecio.this);
