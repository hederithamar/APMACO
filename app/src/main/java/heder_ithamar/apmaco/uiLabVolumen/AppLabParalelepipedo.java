...
public class AppLabParalelepipedo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_lab_paralelepipedo);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_lab_paralelepipedo));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_lab_paralelepipedo));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppLabParalelepipedo.this);
