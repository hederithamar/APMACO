...
public class AppLabTrapecioTab extends AppCompatActivity {
    ...
    private String res, tipo,estructura, forma, descrip, selec,select_unidad, ladoa, ladob, ladoh, Blado, nulo,
            alerta1, aviso, cemVolumen, select_cemento, center;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_app_lab_trapecio_tab);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_lab_trapecio_tab));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_lab_trapecio_tab));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppLabTrapecioTab.this);
