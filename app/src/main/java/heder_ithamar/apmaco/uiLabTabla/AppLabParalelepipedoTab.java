...
public class AppLabParalelepipedoTab extends AppCompatActivity {
    ...
    private String tipo, estructura, forma, descrip, selec,select_unidad, ladoa, ladob, ladoh, nulo, alerta1,
            aviso,cemVolumen, select_cemento, center;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_app_lab_paralelepipedo_tab);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_lab_paralelepipedo_tab));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_lab_paralelepipedo_tab));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppLabParalelepipedoTab.this);
