...
import heder_ithamar.apmaco.uiVolumen.AppVolumenCM;
import heder_ithamar.apmaco.util.TextChangedListener;

public class AppLabVolumenTab extends AppCompatActivity {
    ...
    private Double elem, volumen, diametro, v_elemVolumen, v_totalCem, v_totalAre, v_totalGrab,
            v_totalAgu;
    private String tipo, estructura, forma, descrip, selec, select_unidad, ladoh, nulo, alerta1,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_lab_volumen_tab);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_lab_volumen_tab));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_lab_volumen_tab));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppLabVolumenTab.this);
