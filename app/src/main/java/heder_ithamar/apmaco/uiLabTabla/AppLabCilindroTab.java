...
public class AppLabCilindroTab extends AppCompatActivity {
    ...
    private String tipo,estructura, forma, descrip, selec,select_unidad, nulo, alerta1,
            aviso, cemVolumen, select_cemento, center;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_app_lab_cilindro_tab);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_lab_cilindro_tab));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_lab_cilindro_tab));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppLabCilindroTab.this);
    ...
    public void onClick(View view) {
        ...
        //Boton para guardar valores del volumen
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    manager.insertar(tipo,estructura,forma,nueva.getLado_a(),nueva.getLado_b(),
                            nueva.getLado_h(),nueva.getLado_c(),nueva.getLado_d(),cemVolumen,selec,
