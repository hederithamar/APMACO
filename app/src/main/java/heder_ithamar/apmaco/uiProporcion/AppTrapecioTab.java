...
public class AppTrapecioTab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_trapecio_tab);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_trapecio_tab));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_trapecio_tab));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppTrapecioTab.this);
    ...
    public void onClick(View view) {
        ...
        btnGuardarTolteca.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,Blado,cemTolteca,
                                selec,volumen,elem,t_elemVolumen,t_totalCem,t_totalAre,t_totalGrab,t_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarTolteca.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,Blado,cemTolteca,
                                selec,volumen,elem,t_elemVolumen,t_totalCem,t_totalAre,t_totalGrab,t_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarTolteca.setEnabled(false);
                    }
                    ...
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,Blado,cemTolteca,
                                selec,volumen,elem,t_elemVolumen,t_totalCem,t_totalAre,t_totalGrab,t_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarTolteca.setEnabled(false);
                    }else{
                        manager.insertar4(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,Blado,cemTolteca,
                                selec,volumen,elem,t_elemVolumen,t_totalCem,t_totalAre,t_totalGrab,t_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarTolteca.setEnabled(false);
                    }
        ...
        btnGuardarApasco.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,Blado,cemApasco,
                                selec,volumen,elem,a_elemVolumen,a_totalCem,a_totalAre,a_totalGrab,a_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,Blado,cemApasco,
                                selec,volumen,elem,a_elemVolumen,a_totalCem,a_totalAre,a_totalGrab,a_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }
                    ...
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, Blado, cemApasco,
                                selec, volumen, elem, a_elemVolumen, a_totalCem, a_totalAre, a_totalGrab, a_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }else{
                        manager.insertar4(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, Blado, cemApasco,
                                selec, volumen, elem, a_elemVolumen, a_totalCem, a_totalAre, a_totalGrab, a_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }
        ...
        btnGuardarMoctezu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,Blado,cemMoctezuma,selec,volumen,elem,m_elemVolumen,m_totalCem,m_totalAre,m_totalGrab,m_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,Blado,cemMoctezuma,selec,volumen,elem,m_elemVolumen,m_totalCem,m_totalAre,m_totalGrab,m_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }
                }else{
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, Blado, cemMoctezuma, selec, volumen, elem, m_elemVolumen, m_totalCem, m_totalAre, m_totalGrab, m_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }else{
                        manager.insertar4(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, Blado, cemMoctezuma, selec, volumen, elem, m_elemVolumen, m_totalCem, m_totalAre, m_totalGrab, m_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }
                }
        ...
        btnGuardarAzul.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,Blado,cemAzul,
                                selec,volumen,elem,c_elemVolumen,c_totalCem,c_totalAre,c_totalGrab,c_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,Blado,cemAzul,
                                selec,volumen,elem,c_elemVolumen,c_totalCem,c_totalAre,c_totalGrab,c_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }
                    ...
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,Blado,cemAzul,
                                selec,volumen,elem,c_elemVolumen,c_totalCem,c_totalAre,c_totalGrab,c_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }else{
                        manager.insertar4(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,Blado,cemAzul,
                                selec,volumen,elem,c_elemVolumen,c_totalCem,c_totalAre,c_totalGrab,c_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }
