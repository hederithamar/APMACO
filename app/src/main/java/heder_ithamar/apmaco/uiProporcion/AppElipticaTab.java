...
public class AppElipticaTab extends AppCompatActivity {
    ...
    private String tipo,estructura, forma, descrip, selec, ladoa, ladob, ladoh, nulo,
            alerta1, cemTolteca, cemApasco, cemMoctezuma, cemAzul, aviso,center;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_app_eliptica_tab);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_eliptica_tab));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_eliptica_tab));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppElipticaTab.this);
    ...
    public void onClick(View view) {
        ...
        btnGuardarApasco.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemApasco,selec,
                                volumen,elem,a_elemVolumen,a_totalCem,a_totalAre,a_totalGrab,a_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemApasco,selec,
                                volumen,elem,a_elemVolumen,a_totalCem,a_totalAre,a_totalGrab,a_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }
                    ...
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemApasco, selec,
                                volumen, elem, a_elemVolumen, a_totalCem, a_totalAre, a_totalGrab, a_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }else{
                        manager.insertar4(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemApasco, selec,
                                volumen, elem, a_elemVolumen, a_totalCem, a_totalAre, a_totalGrab, a_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }
        ...
        btnGuardarMoctezu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemMoctezuma,selec,
                                volumen,elem,m_elemVolumen,m_totalCem,m_totalAre,m_totalGrab,m_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemMoctezuma,selec,
                                volumen,elem,m_elemVolumen,m_totalCem,m_totalAre,m_totalGrab,m_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }
                    ...
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemMoctezuma, selec,
                                volumen, elem, m_elemVolumen, m_totalCem, m_totalAre, m_totalGrab, m_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }else{
                        manager.insertar4(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemMoctezuma, selec,
                                volumen, elem, m_elemVolumen, m_totalCem, m_totalAre, m_totalGrab, m_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }
        ...
        btnGuardarAzul.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemAzul,selec,
                                volumen,elem,a_elemVolumen,c_totalCem,c_totalAre,c_totalGrab,c_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemAzul,selec,
                                volumen,elem,a_elemVolumen,a_totalCem,a_totalAre,a_totalGrab,a_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }
                    ...
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemAzul, selec,
                                volumen, elem, c_elemVolumen, c_totalCem, c_totalAre, c_totalGrab, c_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }else{
                        manager.insertar4(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemAzul, selec,
                                volumen, elem, c_elemVolumen, c_totalCem, c_totalAre, c_totalGrab, c_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }
