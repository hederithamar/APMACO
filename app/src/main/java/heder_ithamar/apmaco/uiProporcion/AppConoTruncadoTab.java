...
public class AppConoTruncadoTab extends AppCompatActivity {
    ...
    //Variables
    private Double diametromenor, diametromayor, altura, volumen, elem,
    ...
    private String tipo, estructura, forma, descrip, selec, ladoa, ladob, ladoh, nulo, alerta1,
            cemTolteca, cemApasco, cemAzul, cemMoctezuma, aviso, center;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_app_cono_truncado_tab);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_cono_truncado_tab));
        int idDrawable = R.drawable.conotruncado;
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_cono_truncado_tab));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppConoTruncadoTab.this);
    ...
    private void iniciaCM(){
        ...
        Intent intent = new Intent(this,AppConoTruncadoCM.class);
        //Iniciar actividad
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_app_cono_truncado, menu);
        return true;
    }
    ...
    public void onClick(View view) {if (!validarcmpLargo()) {
        return;
    }
        ...
        diametromenor = Double.parseDouble(ladoa);
        diametromayor = Double.parseDouble(ladob);
        altura = Double.parseDouble(ladoh);

        volumen = calculaVolumen(diametromenor, diametromayor, altura);
        ...
        estructura = this.getString(R.string.btn_conotr);
        nulo = " - ";
        ...
        btnGuardarTolteca.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,nulo,ladoh,ladob,nulo,cemTolteca,selec,volumen,elem,t_elemVolumen,t_totalCem,t_totalAre,t_totalGrab,t_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarTolteca.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,nulo,ladoh,ladob,nulo,cemTolteca,selec,volumen,elem,t_elemVolumen,t_totalCem,t_totalAre,t_totalGrab,t_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarTolteca.setEnabled(false);
                    }
                }else{
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo, estructura, forma, ladoa, nulo, ladoh, ladob, nulo, cemTolteca, selec, volumen, elem, t_elemVolumen, t_totalCem, t_totalAre, t_totalGrab, t_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarTolteca.setEnabled(false);
                    }else{
                        manager.insertar4(tipo, estructura, forma, ladoa, nulo, ladoh, ladob, nulo, cemTolteca, selec, volumen, elem, t_elemVolumen, t_totalCem, t_totalAre, t_totalGrab, t_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarTolteca.setEnabled(false);
                    }
                }
        ...
        btnGuardarApasco.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,nulo,ladoh,ladob,nulo,cemApasco,selec,volumen,elem,a_elemVolumen,a_totalCem,a_totalAre,a_totalGrab,a_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,nulo,ladoh,ladob,nulo,cemApasco,selec,volumen,elem,a_elemVolumen,a_totalCem,a_totalAre,a_totalGrab,a_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }
                }else{
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo, estructura, forma, ladoa, nulo, ladoh, ladob, nulo, cemApasco, selec, volumen, elem, a_elemVolumen, a_totalCem, a_totalAre, a_totalGrab, a_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }else{
                        manager.insertar4(tipo, estructura, forma, ladoa, nulo, ladoh, ladob, nulo, cemApasco, selec, volumen, elem, a_elemVolumen, a_totalCem, a_totalAre, a_totalGrab, a_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }
                }
        ...
        btnGuardarMoctezu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    ...
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,nulo,ladoh,ladob,nulo,cemMoctezuma,selec,volumen,elem,m_elemVolumen,m_totalCem,m_totalAre,m_totalGrab,m_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,nulo,ladoh,ladob,nulo,cemMoctezuma,selec,volumen,elem,m_elemVolumen,m_totalCem,m_totalAre,m_totalGrab,m_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }
                }else{
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo, estructura, forma, ladoa, nulo, ladoh, ladob, nulo, cemMoctezuma, selec, volumen, elem, m_elemVolumen, m_totalCem, m_totalAre, m_totalGrab, m_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }else{
                        manager.insertar4(tipo, estructura, forma, ladoa, nulo, ladoh, ladob, nulo, cemMoctezuma, selec, volumen, elem, m_elemVolumen, m_totalCem, m_totalAre, m_totalGrab, m_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }
                }
        ...
        //Boton para guardar valores de Azul
        btnGuardarAzul.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    ...
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,nulo,ladoh,ladob,nulo,cemAzul,selec,volumen,elem,m_elemVolumen,c_totalCem,c_totalAre,c_totalGrab,c_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,nulo,ladoh,ladob,nulo,cemAzul,selec,volumen,elem,c_elemVolumen,c_totalCem,c_totalAre,c_totalGrab,c_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }
                }else{
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo, estructura, forma, ladoa, nulo, ladoh, ladob, nulo, cemAzul, selec, volumen, elem, c_elemVolumen, c_totalCem, c_totalAre, c_totalGrab, c_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }else{
                        manager.insertar4(tipo, estructura, forma, ladoa, nulo, ladoh, ladob, nulo, cemAzul, selec, volumen, elem, c_elemVolumen, c_totalCem, c_totalAre, c_totalGrab, c_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }
                }
    ...
    private Double calculaVolumen(Double diametromenor, Double diametromayor, Double altura) {
        return (3.1415 * altura * (diametromayor * diametromayor + diametromenor * diametromenor + diametromayor * diametromenor) / 12);
    }
    ...
    public boolean validarcmpLargo(){
        if (txtLargo.getText().toString().trim().isEmpty()) {
            input_cmpLargo.setError(getString(R.string.cmp_diametro0));
    ...
    public boolean validarcmpAncho(){
        if (txtAncho.getText().toString().trim().isEmpty()) {
            input_cmpAncho.setError(getString(R.string.cmp_diametrob));
