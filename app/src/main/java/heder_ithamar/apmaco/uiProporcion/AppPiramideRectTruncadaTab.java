...
public class AppPiramideRectTruncadaTab extends AppCompatActivity {
    ...
    //Variables
    private Double largomayor, anchomayor, altura, largomenor, anchomenor, volumen, elem,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_piramide_rect_truncada_tab);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_piramide_rect_truncada_tab));
        int idDrawable = R.drawable.rectruncada;
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_piramide_rect_truncada_tab));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppPiramideRectTruncadaTab.this);
    ...
    private void iniciaCM(){
        ...
        Intent intent = new Intent(this,AppPiramideRectTruncadaCM.class);
        //Iniciar actividad
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_app_piramide_rect_truncada, menu);
        return true;
    }
    ...
    public void onClick(View view) {
        ...
        largomayor = Double.parseDouble(Alado);
        anchomayor = Double.parseDouble(Blado);
        largomenor = Double.parseDouble(ladoa);
        anchomenor = Double.parseDouble(ladob);
        altura = Double.parseDouble(ladoh);

        volumen = calculaVolumen(largomayor, anchomayor, largomenor, anchomenor, altura);
        ...
        estructura = this.getString(R.string.btn_rectru);
        ...
        btnGuardarAzul.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    ...
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo, estructura, forma, ladoa, ladob, ladoh, Alado, Blado, cemAzul,
                                selec, volumen, elem, c_elemVolumen, c_totalCem, c_totalAre, c_totalGrab, c_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }else{
                        manager.insertar4(tipo, estructura, forma, ladoa, ladob, ladoh, Alado, Blado, cemAzul,
                                selec, volumen, elem, c_elemVolumen, c_totalCem, c_totalAre, c_totalGrab, c_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }
    ...
    private Double calculaVolumen(Double largomayor, Double anchomayor, Double largomenor, Double anchomenor, Double altura) {
        return (altura * (largomayor * anchomayor + largomenor * anchomenor + Math.sqrt(largomayor * anchomayor * largomenor * anchomenor)) / 3);
    }
    ...
    public boolean validarcmpMayor(){
        if (txtMayor.getText().toString().trim().isEmpty()) {
            input_cmpMayor.setError(getString(R.string.cmp_largomayor));
    ...
    public boolean validarcmpMenor(){
        if (txtMenor.getText().toString().trim().isEmpty()) {
            input_cmpMenor.setError(getString(R.string.cmp_anchomayor));
    ...
    public boolean validarcmpLargo(){
        if (txtLargo.getText().toString().trim().isEmpty()) {
            input_cmpLargo.setError(getString(R.string.cmp_largomenor));
    ...
    public boolean validarcmpAncho(){
        if (txtAncho.getText().toString().trim().isEmpty()) {
            input_cmpAncho.setError(getString(R.string.cmp_anchomenor));
