...
public class AppParalelepipedoTab extends AppCompatActivity {
    ...
    //Variables
    private Double longitud, ancho, altura, volumen, elem,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_paralelepipedo_tab);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_paralelepipedo_tab));
        int idDrawable = R.drawable.paralelepipedo;
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_paralelepipedo_tab));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppParalelepipedoTab.this);
    ...
    private void iniciaCM(){
        ...
        Intent intent = new Intent(this,AppParalelepipedoCM.class);
        //Iniciar actividad
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_app_paralelepipedo, menu);
        return true;
    }
    ...
    public void onClick(View view) {
        ...
        ancho = Double.parseDouble(ladob);
        altura = Double.parseDouble(ladoh);

        volumen = calculaVolumen(longitud, ancho, altura);
        ...
        estructura = this.getString(R.string.btn_parale);
        nulo = " - ";
        ...
        btnGuardarTolteca.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemTolteca,selec,
                                volumen,elem,t_elemVolumen,t_totalCem,t_totalAre,t_totalGrab,t_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarTolteca.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemTolteca,selec,
                                volumen,elem,t_elemVolumen,t_totalCem,t_totalAre,t_totalGrab,t_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarTolteca.setEnabled(false);
                    }
                    ...
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemTolteca,selec,
                                volumen,elem,t_elemVolumen,t_totalCem,t_totalAre,t_totalGrab,t_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarTolteca.setEnabled(false);
                    }else{
                        manager.insertar4(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemTolteca,selec,
                                volumen,elem,t_elemVolumen,t_totalCem,t_totalAre,t_totalGrab,t_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarTolteca.setEnabled(false);
                    }
        ...
        btnGuardarApasco.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if (mySwitchSist.isChecked()) {
                        manager.insertar(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemApasco,
                                selec, volumen, elem, a_elemVolumen, a_totalCem, a_totalAre, a_totalGrab, a_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    } else {
                        manager.insertar2(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemApasco,
                                selec, volumen, elem, a_elemVolumen, a_totalCem, a_totalAre, a_totalGrab, a_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }
                    ...
                    if (mySwitchSist.isChecked()) {
                        manager.insertar3(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemApasco,
                                selec, volumen, elem, a_elemVolumen, a_totalCem, a_totalAre, a_totalGrab, a_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    } else {
                        manager.insertar4(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemApasco,
                                selec, volumen, elem, a_elemVolumen, a_totalCem, a_totalAre, a_totalGrab, a_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarApasco.setEnabled(false);
                    }
        ...
        btnGuardarMoctezu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if (mySwitchSist.isChecked()) {
                        manager.insertar(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemMoctezuma,
                                selec, volumen, elem, m_elemVolumen, m_totalCem, m_totalAre, m_totalGrab, m_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    } else {
                        manager.insertar2(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemMoctezuma,
                                selec, volumen, elem, m_elemVolumen, m_totalCem, m_totalAre, m_totalGrab, m_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }
                    ...
                    if (mySwitchSist.isChecked()) {
                        manager.insertar3(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemMoctezuma,
                                selec, volumen, elem, m_elemVolumen, m_totalCem, m_totalAre, m_totalGrab, m_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    } else {
                        manager.insertar4(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemMoctezuma,
                                selec, volumen, elem, m_elemVolumen, m_totalCem, m_totalAre, m_totalGrab, m_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarMoctezu.setEnabled(false);
                    }
        ...
        btnGuardarAzul.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    ...
                    if (mySwitchSist.isChecked()) {
                        manager.insertar3(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemAzul,
                                selec, volumen, elem, c_elemVolumen, c_totalCem, c_totalAre, c_totalGrab, c_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    } else {
                        manager.insertar4(tipo, estructura, forma, ladoa, ladob, ladoh, nulo, nulo, cemAzul,
                                selec, volumen, elem, c_elemVolumen, c_totalCem, c_totalAre, c_totalGrab, c_totalAgu, descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarAzul.setEnabled(false);
                    }
    ...
    private Double calculaVolumen(Double longitud, Double ancho, Double altura) {
