...
/**
 * Actividad para la calcular la forma Piramide.
 */

public class AppPiramide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_piramide);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_piramide));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_piramide));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppPiramide.this);
        ...
        btnGuardarVolumen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mySwitchNormal.isChecked()){
                    if(mySwitchSist.isChecked()){
                        manager.insertar(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemVolumen,selec,volumen,elem,v_elemVolumen,v_totalCem,v_totalAre,v_totalGrab,v_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarVolumen.setEnabled(false);
                    }else{
                        manager.insertar2(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemVolumen,selec,volumen,elem,v_elemVolumen,v_totalCem,v_totalAre,v_totalGrab,v_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarVolumen.setEnabled(false);
                    }
                }else{
                    if(mySwitchSist.isChecked()){
                        manager.insertar3(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemVolumen,selec,volumen,elem,v_elemVolumen,v_totalCem,v_totalAre,v_totalGrab,v_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarVolumen.setEnabled(false);
                    }else{
                        manager.insertar4(tipo,estructura,forma,ladoa,ladob,ladoh,nulo,nulo,cemVolumen,selec,volumen,elem,v_elemVolumen,v_totalCem,v_totalAre,v_totalGrab,v_totalAgu,descrip);
                        Toast.makeText(getApplicationContext(), alerta1, Toast.LENGTH_SHORT).show();
                        btnGuardarVolumen.setEnabled(false);
                    }
                }
