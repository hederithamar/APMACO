...
/**
 * Actividad para la calcular la forma Triangular.
 */

public class AppTriangular extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_triangular);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_triangular));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_triangular));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppTriangular.this);
