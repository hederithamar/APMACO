...
/**
 * Actividad para la calcular la forma Cilindrica.
 */

public class AppCilindro extends AppCompatActivity {
...
aviso, cemVolumen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_cilindro);
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppCilindro.this);
