...
/**
 * Actividad para la calcular la forma Esfera.
 */

public class AppEsfera extends AppCompatActivity {
    ...
    //Variables
    private Double elem, volumen, diametro,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_esfera);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra(getString(R.string.title_activity_app_esfera));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_esfera));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppEsfera.this);
