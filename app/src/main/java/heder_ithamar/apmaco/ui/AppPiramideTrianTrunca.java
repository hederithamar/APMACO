...
/**
 * Actividad para la calcular la forma Piramide triangular truncada.
 */

public class AppPiramideTrianTrunca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_piramide_trian_trunca);
        ...
        Intent i = getIntent();
        String name = i.getStringExtra( getString(R.string.title_activity_app_piramide_trian_trunca));
        ...
        aviso = String.format(getString(R.string.string_aviso), getString(R.string.title_activity_app_piramide_trian_trunca));
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder adb = new AlertDialog.Builder(AppPiramideTrianTrunca.this);
